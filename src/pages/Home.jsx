      ...
      <div id="terms-model" className='d-none'>
        <div className="card">
          ...
          <div className='card-body'>
              ...
              <div class="d-flex flex-row justify-content-end align-items-center" style={{marginTop:'10px', background:'#e5e5e5', width:'100%', padding:'10px 20px 10px 20px', borderRadius:'5px'}}>
                <button className='btn btn-success accept' style={{marginRight:'20px'}} onClick={acceptTermsViaPopup}>Accept</button>
